...
@dg.asset(name='parse_consultations_data', group_name='preprocessing')
def parse_consultations_data():

    consultations = pd.read_csv('../datalake/raw/consultas_dummy.csv', sep=';')
...
@dg.asset(deps=["parse_consultations_data"], name='parse_consultations_diagnosis_data', group_name='preprocessing')
